...
import qualified Puzzles.P14 as P14
...
puzzle14 :: Spec
puzzle14 = describe "puzzle 14" $ do
  let ex0 = [r|10 ORE => 10 A
1 ORE => 1 B
7 A, 1 B => 1 C
7 A, 1 C => 1 D
7 A, 1 D => 1 E
...
|]
      ex2 = [r|2 VPVL, 7 FWMGM, 2 CXFTF, 11 MNCFX => 1 STKFG
...
|]
  ...
  describe "part 1" $ do
    let example = puzzleExample P14.inputParser P14.pt1
    example 0 ex0 31
    example 3 ex3 2210736

  describe "part 2" $ do
    let example = puzzleExample P14.inputParser P14.pt2
    example 1 ex1 82892753
    example 2 ex2 5586022
    example 3 ex3 460664
